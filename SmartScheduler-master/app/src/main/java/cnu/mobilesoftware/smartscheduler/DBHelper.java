...
public class DBHelper extends SQLiteOpenHelper{
    ...
    public HashMap<String, Memo> getMemoListFromDB(){
        ...
        try{
            ...
            cursor.moveToFirst();
            while(!cursor.isAfterLast()){
                int _ID = cursor.getInt(cursor.getColumnIndex(TableInfo.SCHEDULE_ITEM_LIST._ID));
                String DATE_TIME = cursor.getString(cursor.getColumnIndex(TableInfo.SCHEDULE_ITEM_LIST.DATE_TIME));
                String CONTENT = cursor.getString(cursor.getColumnIndex(TableInfo.SCHEDULE_ITEM_LIST.CONTENT));
    ...
    public void insertMemoinDB(Memo memo){
        ...
        try{
            db = getWritableDatabase();
            ContentValues contentValues = new ContentValues();
            contentValues.put(TableInfo.SCHEDULE_ITEM_LIST.DATE_TIME, memo.getDataTimeToString());
            contentValues.put(TableInfo.SCHEDULE_ITEM_LIST.CONTENT, memo.getContent());
            db.insert(TableInfo.SCHEDULE_ITEM_LIST.TABLE_NAME, null, contentValues);
        } catch (Exception e){
            Log.e("getMemoListFromDB", e.toString());
        } finally{
    ...
    public void updateMemoinDB(Memo memo){
        ...
        try{
            ...
            db.update(TableInfo.SCHEDULE_ITEM_LIST.TABLE_NAME,
                    contentValues,
                    TableInfo.SCHEDULE_ITEM_LIST._ID + "=?",
                    params);
        } catch (Exception e){
    ...
    public void deleteMemoinDB(Memo memo){
        ...
        try{
            db = getWritableDatabase();
            db.delete(TableInfo.SCHEDULE_ITEM_LIST.TABLE_NAME, TableInfo.SCHEDULE_ITEM_LIST._ID + "=?", new String[]{String.valueOf(memo.getID())});
        }catch (Exception e){
            e.printStackTrace();
